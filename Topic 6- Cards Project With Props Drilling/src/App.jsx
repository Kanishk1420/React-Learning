...
const App = () => {
  const jobOpenings = [
    ...
    {
      brandLogo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWhqOC_8TpCUmksmFEIm1YqtkLvN8N-S1dew&s",
      companyName: "Google",
  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(element){
        return <Card companyname={element.companyName} brand={element.brandLogo} date={element.datePosted} post={element.post} tag1={element.tag1} tag2={element.tag2} pay={element.pay} location={element.location}/>
      })}
    </div>
  )
}
